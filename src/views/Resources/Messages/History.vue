...
<div>
  ...
  <div class="card border-0 g-mb-15">
    ...
    <div class="card-header d-flex align-items-center justify-content-between g-bg-gray-light-v5 border-0 g-mb-15">
      <h3 class="h6 mb-0">
        <i class="icon-bubbles g-pos-rel g-top-1 g-mr-5"></i> 与 <router-link :to="{ path: `/user/${user.id}` }" class="g-text-underline--none--hover">{{ user.name || user.username }}</router-link> 的对话 <small v-if="messages_list">(共 {{ count }} 条, {{page_total }} 页)</small>
      </h3>
