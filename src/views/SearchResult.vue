<template>
    <div class="container">
        ...
        <!-- Modal: Edit Post -->
        <div data-backdrop="static" class="modal fade" id="editPostModal" tabindex="-1" role="dialog"
        ...
        <div class="card border-0 g-mb-15">
            ...
            <div class="card-header d-flex align-items-center justify-content-between g-bg-gray-light-v5 border-0 g-mb-15">
                <h3 class="h6 mb-0">
                    <i class="icon-bubbles g-pos-rel g-top-1 g-mr-5"></i> 查询结果
          ...
          <span class="d-block g-color-primary--hover g-cursor-pointer g-mr-minus-5 g-pa-5" data-toggle="dropdown"
            ...
            <div v-if="datalist" class="card-block g-pa-0">
                ...
                <div class="media g-brd-around g-brd-gray-light-v4 g-brd-left-1 g-pa-20 g-mb-20"
                    ...
                    <router-link :to="{ path: `/user/${post.object.author.id}` }"
                                 :title="post.object.author.name || post.object.author.username">
                        ...
                        <img class="d-flex g-brd-around g-brd-gray-light-v3 g-pa-2 g-width-40 g-height-40 rounded-circle rounded mCS_img_loaded g-mt-3 g-mr-15"
                             :src="post.object.author.avatar"
                             :alt="post.object.author.name || post.object.author.username">
                    </router-link>
                    ...
                    <div class="media-body">
                        <div class="g-mb-15">
                            <h5 class="h5 g-color-gray-dark-v1 mb-0">
                                <router-link :to="{ path: `/user/${post.object.author.id}` }"
                                             class="g-text-underline--none--hover">{{ post.object.author.name ||
                                    post.object.author.username }}
                                </router-link>
                                <span class="h6">发布了文章<router-link
                                        :to="{ name: 'PostDetail', params: { id: post.object.id }, query: { q: $route.query.q, page: $route.query.page, per_page: $route.query.per_page } }"
                                        class="g-text-underline--none--hover">《<span v-html="post.object.title"></span>》</router-link></span>
                            </h5>
                        ...
                        <div class="d-flex justify-content-start">
                            <ul class="list-inline mb-0">
                                ...
                                <li class="list-inline-item g-mr-20">
                                    <router-link :to="{ path: `/post/${post.object.id}#like-post` }"
                                ...
                                <li class="list-inline-item g-mr-20">
                                    <router-link :to="{ path: `/post/${post.object.id}#comment-list-wrap` }"
                                                 class="g-color-gray-dark-v5 g-text-underline--none--hover">
                                        <i class="icon-bubble g-pos-rel g-top-1 g-mr-3"></i> {{
                                        post.object.comments_count }}
                                    </router-link>
                                </li>
                            </ul>
                            <ul class="list-inline mb-0 ml-auto">
                                ...
                                <li v-if="post.object.author.id == sharedState.user_id || sharedState.user_perms"
                                    class="list-inline-item g-mr-5">
                                    <button @click="onEditPost(post.object)" class="btn btn-xs u-btn-outline-purple"
                                            data-toggle="modal" data-target="#editPostModal">编辑
                                    </button>
                                </li>
                                <li v-if="post.object.author.id == sharedState.user_id || sharedState.user_perms"
                                    class="list-inline-item">
                                    <button @click="onDeletePost(post.object)" class="btn btn-xs u-btn-outline-red">
                                        删除
                                    </button>
                                </li>
                            </ul>
