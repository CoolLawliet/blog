    ...
    <div class="row">
      <div class="col-md-4">
        <form @submit.prevent="onSubmit">
          <div class="form-group"  :class="{'u-has-error-v1': registerForm.usernameError}" >
          ...
          <div class="form-group" :class="{'u-has-error-v1': registerForm.emailError}" >
          ...
          <div class="form-group" :class="{'u-has-error-v1': registerForm.passwordError}" >
