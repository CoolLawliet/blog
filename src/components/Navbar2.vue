   ...
   <nav class="navbar navbar-expand-lg navbar-light bg-light" style="margin-bottom: 20px;">
      ...
      <router-link to="/" class="navbar-brand">
        ...
        <p class="navbar-nav mr-auto  mt-lg-0"  v-if="sharedState.is_authenticated">
            ...
            <router-link :to="{ path: '/notifications/comments' }" class="nav-link"><i class="icon-education-033 u-line-icon-pro g-color-red g-font-size-16 g-pos-rel g-top-2 g-mr-3"></i> 通知 <span id="new_notifications_count" style="visibility: hidden;" class="u-label g-font-size-11 g-bg-aqua g-rounded-20 g-px-10">0</span></router-link>
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        ...
        <ul v-if="sharedState.is_authenticated" class="nav navbar-nav navbar-right">
           ...
           <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
              <img :src="sharedState.user_avatar" class="g-brd-around g-brd-gray-light-v3 g-pa-2 g-width-40 g-height-40  rounded-circle rounded mCS_img_loaded g-mt-3 g-mr-15""> {{ sharedState.user_name }}
            </a>

            <div class="dropdown-menu" aria-labelledby="navbarDropdown">
               <router-link :to="{ path: `/user/${sharedState.user_id}` }" class="dropdown-item"><i class="icon-star g-pos-rel g-top-1 g-mr-5"></i>我的主页</router-link>
              <router-link :to="{ name: 'PostsResource' }" class="dropdown-item"><i class="icon-share g-pos-rel g-top-1 g-mr-5"></i> Your resource</router-link>
              <router-link :to="{ name: 'SettingProfile' }" class="dropdown-item"><i class="icon-settings g-pos-rel g-top-1 g-mr-5"></i> 设置</router-link>
              <div class="dropdown-divider"></div>
               <a @click="handlerLogout" class="dropdown-item" href="#"><i class="icon-logout g-pos-rel g-top-1 g-mr-5"></i> 退出</a>
            </div>
          </li>
        </ul>
