				...
				<el-col :span="24">
					...
					<div class="headBox">
						<el-menu :default-active="activeIndex" class="el-menu-demo" mode="horizontal" @select="handleSelect" :router="true">
							...
							<el-menu-item v-if="sharedState.is_authenticated" index="/notifications/comments">
								...
								<router-link :to="{ path: '/notifications/comments' }" ><i class="el-icon-chat-dot-square"></i>通知 <span id="new_notifications_count" style="visibility: hidden;" class="u-label  g-bg-aqua g-rounded-20 ">0</span></router-link>
							</el-menu-item>
							...
							<div class="userInfo">
								...
								<div v-if="sharedState.is_authenticated" class="haslogin">
									...
									<ul class="haslogin-info">
										...
										<li>
											<router-link :to="{ name: 'PostsResource' }" class="dropdown-item"><i class="icon-share g-pos-rel g-top-1 g-mr-5"></i> 我的资源</router-link>
					...
					<div class="mobileBox">
						<div class="hideMenu">
							...
							<el-collapse-transition>
								<el-menu :default-active="activeIndex" class="mlistmenu" v-show="!pMenu"  @open="handleOpen" @close="handleClose" :unique-opened="true" :router="true">
									...
									<el-submenu v-if="sharedState.is_authenticated" index="3">
										...
										<router-link :to="{ name: 'PostsResource' } ">
										<el-menu-item >
											我的资源
										</el-menu-item>
										</router-link>
							...
							<div class="searchBox ">
								<form v-if="sharedState.is_authenticated" @submit.prevent="onSubmitSearch">
									<router-link :to="{ path: '/notifications/comments' }" ><i style="font-style:normal" class="icon-education-033 u-line-icon-pro  g-font-size-16 g-pos-rel g-top-5 g-mr-3"></i>  <span id="mobile_new_notifications_count" style="visibility: hidden;" class="u-label g-font-size-11 g-bg-aqua g-rounded-20 g-px-10">0</span></router-link>
									&nbsp;&nbsp;
