...
<template>
    ...
    <div  class="footBack footBackQian">
        <div class="footer-img" :style="{background:'url(../../../static/img/footer01.png) no-repeat 50%'}">
        </div>
        <div class="fcontainer">
            ...
            <p>
                © 2019 lzd. 由 Django 强力驱动. Theme By LZD. 陇ICP备17004101号-1.
            </p>
            <p>
                <span>Made with</span> <img class="fheart" src="../../static/img/heart02.png"/>  <span>by lzd.</span>
            </p>
        </div>
    </div>
    ...
    export default {
        ...
        methods: { //事件处理器
            runTime:function(){//运行倒计时
                var that = this;
                var oldTime =new Date('2019/08/14 00:00:00');
